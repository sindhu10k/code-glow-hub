        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2 text-sm">
              ...
              <a href="#languages" className="block text-muted-foreground hover:text-neon-cyan transition-colors">Languages</a>
              <a href="#" className="block text-muted-foreground hover:text-neon-cyan transition-colors">Collaboration</a>
              <a href="#" className="block text-muted-foreground hover:text-neon-cyan transition-colors">API(Coming Soon)</a>
            </div>
          </div>
        ...
        <div className="border-t border-border mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-sm text-muted-foreground">
              © 2025 TryCodeNow. All rights reserved.
            </div>
